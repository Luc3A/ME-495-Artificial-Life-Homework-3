...
wiggleTorque = random.randint(30,100)
...
for i in motorList:
    ...
    if i == 4:
        step1 = np.append(step1, [5, -10, 10, -5])
        step2 = np.append(step2, [-10, 5, -5, 10])

stepList = np.array([step1, step2])

model = mj.MjModel.from_xml_path('bugDosPoint0.xml')
...
weight = numSegments * weightMultiplier
